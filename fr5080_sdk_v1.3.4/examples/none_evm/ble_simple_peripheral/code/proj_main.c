...
void user_custom_parameters(void)
{
    ...
    pskeys.local_bdaddr.addr[5] = 0x09;
    ...
    pskeys.enable_profiles = ENABLE_PROFILE_HF|ENABLE_PROFILE_A2DP;  //enable hfp,a2dp profile
...
{    
    ...
    //bt_hf_set_cb_func(proj_bt_hf_evt_func);
    //bt_a2dp_set_cb_func(proj_bt_a2dp_evt_func);
    //bt_me_set_cb_func(proj_bt_me_evt_func);
    //bt_avrcp_set_cb_func(proj_bt_avrcp_evt_func);
