...
3       EMSI     W/R        ?бу1?б└: Enable Modem Status Interrupt (EMSI)
                                    ?бу0?б└: Disable EMSI
2       ERLSI   W/R         ?бу1?б└: Enable Receive Line Status Interrupt (ERLSI)
                                    ?бу0?б└: Disable ERLSI
1       ETI      W/R          ?бу1?б└: Enable THR Empty Interrupt (ETI)
                                    ?бу0?б└: Disable ETI
0       ERDI    W/R          ?бу1?б└: Enable Received Data Available Interrupt (ERDI)
                                    ?бу0?б└: Disable ERDI
*/
/*address: 0x04*/
...
5:4     Tx Trigger WO       Indicate the trigger level for the transmit FIFO interrupt.
                                        ...
                                        10 --- FIFO 1/4 full
                                        11 --- FIFO 1/2 full
3       DMA          WO         ?бу0?б└ TXRDYN,RXRDYN signal work in DMA mode 0
        Mode                        ?бу1?б└ TXRDYN,RXRDYN signal work in DMA mode 1
...
3       OUT2        W/R       User Designated Output
                                        ?бу1?б└: set OUT2n to ?бу0?б└, active
                                        ?бу0?б└: set OUT2n to ?бу1?б└, normal
2       OUT1        W/R       User Designated Output
                                        ?бу1?б└: set OUT1n to ?бу0?б└, active
                                        ?бу0?б└: set OUT1n to ?бу1?б└, normal
1       RTS          W/R        Request to Send
                                        ?бу1?б└: set RTSn to ?бу0?б└, active
                                        ?бу0?б└: set RTSn to ?бу1?б└, normal
0       DTR         W/R         Data Terminal Ready
                                        ?бу1?б└: set DTRn to ?бу0?б└, active
                                        ?бу0?б└: set DTRn to ?бу1?б└, normal
*/
/*address: 0x10*/
 ...
 *
 * @param   bandrate    - such as BAUD_RATE_115200.
 *
 * @return  None.
 */
 ...
 *
 * @param   buf         - store position of data to be received
 ...
 *
 * @param   bufptr      - store position of data to be send
