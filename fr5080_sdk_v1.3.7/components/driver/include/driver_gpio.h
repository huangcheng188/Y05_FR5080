 ...
 * MACROS
 */
#define GPIO_PORTA_DATA         (GPIO_BASE + 0x00)
#define GPIO_PORTB_DATA         (GPIO_BASE + 0x04)
#define GPIO_PORTC_DATA         (GPIO_BASE + 0x08)
#define GPIO_PORTD_DATA         (GPIO_BASE + 0x0c)
#define GPIO_PORTA_DIR          (GPIO_BASE + 0x10)
#define GPIO_PORTB_DIR          (GPIO_BASE + 0x14)
#define GPIO_PORTC_DIR          (GPIO_BASE + 0x18)
#define GPIO_PORTD_DIR          (GPIO_BASE + 0x1c)
#define GPIO_INT_ENABLE         (GPIO_BASE + 0x20)
 ...
 * @fn      gpio_int_enable
 *
 * @brief   route the specified pin to extern interrupt module.
 *
 * @param   port    - which port this channel belongs to. @ref system_port_t
 *          bit     - channel number. @ref system_port_bit_t
 *
 ...
 * @fn      gpio_int_disable
 *
 * @brief   disconnect the specified pin from extern interrupt module.
 *
 * @param   port    - which port this channel belongs to. @ref system_port_t
 *          bit     - channel number. @ref system_port_bit_t
 *
