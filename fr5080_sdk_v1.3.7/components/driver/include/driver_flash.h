...
* @fn      flash_protect
*
* @brief   protect flash, erase and write flash will be prevented 
*
* @param   None.
*
* @return  None.
*/
__attribute__((section("ram_code"))) void flash_protect_enable(void);


/*********************************************************************
* @fn      flash_unprotect
*
* @brief   unprotect flash, erase and write flash is allowed 
*
* @param   NULL	
*
* @return  None.
*/
__attribute__((section("ram_code"))) void flash_protect_disable(void);

void flash_protect_enable_nonvolatile(void);
