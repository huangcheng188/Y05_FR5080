 ...
 * @fn      gap_set_mtu
 *
 * @brief   Set max transfer unit length. default mtu value is 247.
...
/**********************************************************************
 * @fn      is_ble_conn_latency_enabled
 *
 * @brief   Check if conn latency is enabled.
 *
 * @param   None
 *
 * @return  Enabled or not.
 */
uint8_t is_ble_conn_latency_enabled(void);

/**********************************************************************
 * @fn      gap_ble_conn_latency_enable
 *
 * @brief   Set conn latency enabled.
 *
 * @param   None
 *
 * @return  None.
 */
void gap_ble_conn_latency_enable(void);

/**********************************************************************
 * @fn      gap_ble_conn_latency_disable
 *
 * @brief   Set conn latency disabled.
 *
 * @param   None
 *
 * @return  None.
 */
void gap_ble_conn_latency_disable(void);
